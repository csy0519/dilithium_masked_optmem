...
void shake128(uint8_t *output, size_t outlen,
              const uint8_t *input, size_t inlen, uint8_t buf[sizeof(shake128ctx)]) {
...
void shake256(uint8_t *output, size_t outlen,
              const uint8_t *input, size_t inlen, uint8_t buf[sizeof(shake256ctx)]) {
