...
/*************************************************
* Name:        PQCLEAN_DILITHIUM2_MASK_OPTMEM_power2round
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM2_MASK_OPTMEM_decompose
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM2_MASK_OPTMEM_make_hint
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM2_MASK_OPTMEM_use_hint
*
...
int32_t PQCLEAN_DILITHIUM2_MASK_OPTMEM_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = PQCLEAN_DILITHIUM2_MASK_OPTMEM_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
